...
<head>
    ...
    <link rel="stylesheet" href="css/inscriptionProducteur.css">
    ...
    <div class="signup__container">
        <div class="container__child signup__thumbnail">
            ...
            <div class="thumbnail__content text-center">
                ...
                <h2 class="heading--secondary">Est-tu pret a devenir producteur?</h2>
            </div>
        ...
        <div class="container__child signup__form">
            <form action="#">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="username" id="username" placeholder="chauffeur responsable" required />
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control" type="text" name="email" id="email" placeholder="chauffeur.responsable@planete.com" required />
                </div>
                <div class="form-group">
